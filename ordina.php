...
<section class="order-section">
    <div class="container">
        <div class="order-content">
            <h1 class="menu-title-animation" style="color:#BB0620; margin-top: 75px;">21 OVEN direttamente a casa tua!</h1>
            ...
            <div class="grid">
                ...
                <div class="item">
                    <div class="delivery-text">
                        ...
                        <p>Ricevi la tua pizza in 30-45 minuti a casa.</p>
                ...
                <div class="item">
                    <div class="delivery-text">
                        ...
                        <p>Chiama, ordina e ritira quando vuoi senza attese.</p>
                        <a href="tel:+390566234567" class="order-button">Chiama per ordinare</a>
                    </div>
                </div>
            </div>
        </div>
